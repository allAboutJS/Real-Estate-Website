export default function Testimonials() {
    ...
    return (
        <section className="bg-gradient-to-r from-blue-400 to-blue-700 px-6 py-16 max-w-screen-xl mx-auto rounded-2xl">
            ...
            <div className="max-w-screen-lg m-auto grid grid-cols-1 md:grid-cols-3 gap-2 mt-12">
                {testimonials.map((testimony) => (
                    <blockquote
                        className="bg-blue-300 text-blue-900 p-4 hover:shadow-md rounded-2xl"
